...
- **Extended vthread tracking**: Elio distinguishes construction-time parentage, first-activation parentage, and vthread ownership. This preserves low-overhead virtual stack debugging while making `co_await`, `spawn()`, `go()`, and work stealing semantics explicit.
